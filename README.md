...
I love building applications that solve real-world problems and create impact 🚀
## 🛠️ Tech Stack

<p>
  <img src="https://skillicons.dev/icons?i=flutter,dart,python,firebase,react,fastapi,git,github,vscode" />
</p>
## 📌 Featured Projects

| Project | Description | Tech Stack |
|--------|------------|------------|
| HeForHer App | AI-powered empathy learning app | Flutter, Firebase, OpenAI |
